...
export const getExercises = async (req: AuthRequest, res: VercelResponse): Promise<void> => {
  try {
...
export const createExercise = async (req: AuthRequest, res: VercelResponse): Promise<void> => {
  try {
    const userId = req.user?.userId;
...
export const getExerciseById = async (req: AuthRequest, res: VercelResponse): Promise<void> => {
  try {
